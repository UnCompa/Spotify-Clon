...
const CurrentSong = ({ image, title, artists }) => {
  if (image === undefined) {
    image = "https://ak.picdn.net/shutterstock/videos/1100199023/thumb/1.jpg";
    title = "Sin cancion";
    artists = ["-"];
  }
  return (
      ...
      <div className="grid place-content-center gap-4">
        <div className="flex justify-center flex-col items-center">
          <div className="flex justify-center w-full items-center gap-x-2">
            <button
              className="bg-black rounded-full p-2 fill-zinc-500 h-8 w-8 hover:fill-white transition-colors duration-300"
